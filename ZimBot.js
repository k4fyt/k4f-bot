...
//https.wa.me/212696093857[target]https.wa.me/212696093857\\
	const reply = (teks) => {
            ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join K4f Bot Support GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Media/pictures/icon.jpg`),"sourceUrl": "https://chat.whatsapp.com/Ip8FMSDeUwn7WkX4Qjvimd"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` FOLLOW K4f OFC TT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Media/pictures/icon.jpg`),"sourceUrl": "https://www.tiktok.com/@.k4f_"}}}, { quoted: m})
        }
try {
...
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
		...
		let { pinterest } = require('./lib/scraper')
            ...
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
                ZimBotInc.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'K4F BOTINC ' + command }, { quoted: m })
            }
            break
           ...
           ZimBotInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	ZimBotInc.sendMessage(`212696093857@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
