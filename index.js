...
async function startZimBotInc() {
    ...
    const ZimBotInc = ZimBotIncConnect({
        ...
        browser: ['SUB K4F OFC','Safari','1.0.0'],
        auth: state,
        version
    })
    ...
    ZimBotInc.sendMessage(`212696093857@s.whatsapp.net`, {text: `*REPORT Bot:* Someone is violating the bot rules by calling it`})
    await sleep(8000)
